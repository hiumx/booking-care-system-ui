            ...
            <div className="card-body">
                <div className="doctor-widget doctor-profile-two">
                    ...
                    <div className="doc-info-left">
                        <div className="doctor-img">
                            <img src={doctorImg} className="img-fluid" alt="User" />
                        </div>
                        <div className="doc-info-cont">
                            ...
                            <h4 className="doc-name">
                                Nguyễn Văn A <img src={badgeCheck} alt="Badge" />
                                <span className="badge doctor-role-badge">
                                    <i className="fa-solid fa-circle"></i> Nha khoa
                                </span>
                            </h4>
                            <p>Bệnh viện Đà Nẵng</p>
                            <p>Trình độ : Tiến sĩ</p>
                ...
                <div className="doc-profile-card-bottom">
                    ...
                    <div className="bottom-book-btn">
                        <p>
                            <span>Giá : 300.000đ - 500.000đ </span> mỗi lượt khám
                        </p>
                        <div className="clinic-booking">
                            <Link className={clsx(styles.link, 'apt-btn')} to="/booking">
                                Đặt lịch hẹn
                            </Link>
                        </div>
                    </div>
