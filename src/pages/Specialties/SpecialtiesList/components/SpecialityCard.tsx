...
const SpecialityCard: React.FC<SpecialityCardProps> = ({ id, name, doctorCount, image_url }) => {
    const detailPath = PATHS.SPECIALTIES.DETAIL.replace(':id', id);
                ...
                <div className={clsx('card-body', 'p-3')}>
                    ...
                    >
                        <div className={clsx('d-flex', 'align-items-center')}>
                            <Link to={detailPath} className={clsx('speciality-icon')}>
                                <img src={image_url} alt={name} />
                            </Link>
                            <div className={clsx('ms-3')}>
                                <h6 className="mb-1">
                                    <Link to={detailPath} className={clsx(styles.customLink)}>
                                        {name}
                                    </Link>
                                </h6>
                        ...
                        <Link to={detailPath} className={clsx('link-icon')}>
