...
((t) => {
                ...
                left: function (t, e) {
                    ...
                    s < e.collisionWidth
                        ? 0 < a && r <= 0
                            ...
                            : (t.left = !(0 < r && a <= 0) && r < a ? n + s - e.collisionWidth : n)
                        : 0 < a
                          ? (t.left += a)
                          : 0 < r
                            ? (t.left -= r)
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[0];
                    a < 0
                        ? ((n = t.left + r + l + h + e.collisionWidth - n - s) < 0 || n < k(a)) &&
                          (t.left += r + l + h)
                        : 0 < o &&
                          (0 < (s = t.left - e.collisionPosition.marginLeft + r + l + h - i) ||
                              k(s) < o) &&
                          (t.left += r + l + h);
                },
                top: function (t, e) {
                    var i = e.within,
                        ...
                        h = -2 * e.offset[1];
                    a < 0
                        ? ((n = t.top + r + l + h + e.collisionHeight - n - s) < 0 || n < k(a)) &&
                          (t.top += r + l + h)
                        : 0 < o &&
                          (0 < (s = t.top - e.collisionPosition.marginTop + r + l + h - i) ||
                              k(s) < o) &&
                          (t.top += r + l + h);
                },
            },
            ...
            g(t, function (t, s) {
                ((u.cssHooks[s] = {
                    ...
                    (u.fx.step[s] = function (t) {
                        (t.colorInit ||
                            ((t.start = p(t.elem, s)), (t.end = p(t.end)), (t.colorInit = !0)),
    ...
    function J(t) {
        for (
            var e, i = t.ownerDocument.defaultView.getComputedStyle(t), s = {}, n = i.length;
            n--;
        ...
        st =
            ...
            V.effects.define('bounce', function (t, e) {
                ...
                for (
                    ...
                    (((i = {})[p] = (f ? '-=' : '+=') + l),
                        ...
                        (l = a ? 2 * l : l / 2));
                (a && (((i = { opacity: 0 })[p] = (f ? '-=' : '+=') + l), n.animate(i, u, d)),
                    n.queue(e),
            ...
            V.widget('ui.autocomplete', {
                ...
                _isEventTargetInWidget: function (t) {
                    ...
                    return (
                        t.target === this.element[0] || t.target === e || V.contains(e, t.target)
                    );
                },
    ...
    function at() {
        V.datepicker._isDisabledDatepicker((S.inline ? S.dpDiv.parent() : S.input)[0]) ||
    ...
    (V.extend(V.ui, { datepicker: { version: '1.14.1' } }),
        V.extend(nt.prototype, {
                ...
                !s ||
                    ...
                    (this._datepickerShowing &&
                        ...
                        (i = this._get(s, 'onClose')) &&
                            i.apply(s.input ? s.input[0] : null, [s.input ? s.input.val() : '', s]),
            ...
            parseDate: function (e, n, t) {
                ...
                if (
                    (s = this._daylightSavingAdjust(new Date(u, d - 1, p))).getFullYear() !== u ||
                    s.getMonth() + 1 !== d ||
                    s.getDate() !== p
                )
                    throw 'Invalid date';
                ...
                if ((A < 0 && ((A += 12), E--), O))
                    for (
                        e = this._daylightSavingAdjust(
                            new Date(O.getFullYear(), O.getMonth() - P[0] * P[1] + 1, O.getDate())
                        ),
                            e = z && e < z ? z : e;
            ...
            _canAdjustMonth: function (t, e, i, s) {
                ...
                return (
                    e < 0 && i.setDate(this._getDaysInMonth(i.getFullYear(), i.getMonth())),
                    this._isInRange(t, i)
                );
            },
        ...
        V.widget('ui.draggable', V.ui.mouse, {
            ...
            _getParentOffset: function () {
                ...
                return (
                    ...
                    {
                        top:
                            (t = this._isRootNode(this.offsetParent[0]) ? { top: 0, left: 0 } : t)
        ...
        V.widget('ui.resizable', V.ui.mouse, {
            ...
            _mouseCapture: function (t) {
                ...
                for (e in this.handles)
                    ((i = V(this.handles[e])[0]) !== t.target && !V.contains(i, t.target)) ||
                        (s = !0);
            ...
            resize: function (t) {
                ...
                (a[0] !== document && /static/.test(a.css('position')) && (o = s),
                    n.left < (e._helper ? s.left : 0) &&
                        ((e.size.width =
                            e.size.width +
                            (e._helper ? e.position.left - s.left : e.position.left - o.left)),
        ...
        V.widget('ui.dialog', {
            ...
            _setOption: function (t, e) {
                ...
                'disabled' !== t &&
                    ...
                    'draggable' === t &&
                        ((i = s.is(':data(ui-draggable)')) && !e && s.draggable('destroy'), !i) &&
                        e &&
                        this._makeDraggable(),
                        ...
                        this.selectees.each(function () {
                            ...
                            t &&
                                ...
                                'touch' === o.tolerance
                                    ...
                                    : 'fit' === o.tolerance &&
                                      (e = a < i.left && i.right < l && r < i.top && i.bottom < h),
                                e
                                    ? (t.selected &&
    ...
    (V.ui.spinner,
        V.widget('ui.tabs', {
            ...
            _findNextTab: function (t, e) {
                ...
                for (
                    ;
                    -1 !== V.inArray((t = (t = i < t ? 0 : t) < 0 ? i : t), this.options.disabled);
                        ...
                        (r._isLocal(e)
                            ...
                            : ((s = o.attr('aria-controls') || V({}).uniqueId()[0].id),
                              (i = r.element.find('#' + s)).length ||
                                  (i = r._createPanel(s)).insertAfter(r.panels[t - 1] || r.tablist),
            ...
            _getIndex: function (t) {
                return (t =
                    'string' == typeof t
                        ? this.anchors.index(this.anchors.filter("[href$='" + CSS.escape(t) + "']"))
                        : t);
            },
            _destroy: function () {
                (this.xhr && this.xhr.abort(),
