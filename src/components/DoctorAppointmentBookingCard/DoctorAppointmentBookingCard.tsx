            ...
            <div className={styles.card}>
                <div className="d-md-flex align-items-center">
                    <div className={styles.cardImg}>
                        ...
                        <div
                            className={clsx(styles.gridOverlayItem, "d-flex align-items-center justify-content-between")}   >
                            <span className={clsx(styles.badge, styles.bgOrange, 'badge')}>
                                <i className="fa-solid fa-star me-1"></i>{rating}
                            </span>
                            <span
                                className={clsx(styles.favIcon, { [styles.isSelected]: isSelected })}
                    ...
                    <div className="card-body p-0">
                        <div
                            ...
                            <a href="#" className={clsx(styles.doctorSpecialty, 'text-teal', 'fw-medium', 'fs-14')}>
                                {specialty}
                            </a>
                        </div>
                        <div className="p-3">
                                    ...
                                    <div className="col-sm-6">
                                        <div>
                                            <h6 className='d-flex align-items-center mb-1'>
                                                <a href="doctor-profile.html" className={styles.doctorInfoName}>{name}</a>
                                                <i
                                                    className="isax isax-tick-circle5 text-success ms-2"></i>
                                            </h6>
                                            <p className={clsx(styles.fs15, 'mb-2')}>{position}</p>
                                            <p className="d-flex align-items-center mb-0 fs-14"><i
                                                className="isax isax-location me-2"></i>{location}
                                                <a href="#"
                                                    className="text-primary text-decoration-underline ms-2">Get
                                                    Direction</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div>
                                            <p className="d-flex align-items-center mb-0 fs-14 mb-2">
                                                <i
                                                    className="isax isax-language-circle text-dark me-2"></i>{bookCounts} booked
                                            </p>
                                            <p className="d-flex align-items-center mb-0 fs-14 mb-2">
                                            ...
                                            <p className="d-flex align-items-center mb-0 fs-14">
                                                <i
                                                    className="isax isax-archive-14 text-dark me-2"></i>
                            ...
                            <div
                                className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mt-3">
                                <div className="d-flex align-items-center flex-wrap row-gap-3">
                                    <div className="me-3">
                                        <p className={clsx(styles.fs15, 'mb-1')}>Consultation Fees</p>
                                        <h3 className="text-orange">{`$${fees}`}</h3>
                                    </div>
                                    <p className={clsx(styles.fs15, 'mb-0')}>Next available at <br />{nextAvailableTime}</p>
                                </div>
                                <a href="booking.html"
